...
On hosted zones, the Domains page DNS table lets you **add / edit / delete** A, AAAA, CNAME, TXT, SRV, and CAA records. **MX, SPF, DKIM, DMARC, NS, SOA, and ns1/ns2 glue A/AAAA** are greyed out (“locked”) — only panel mail security / Settings may change those.
